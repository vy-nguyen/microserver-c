...
class ListCommon(BaseModel):
    """
    ListCommon
    """ # noqa: E501
    page_info: PageInfo = Field(alias="pageInfo")
    extras: Optional[List[ItemId]] = None
    __properties: ClassVar[List[str]] = ["pageInfo", "extras"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "extras": [ItemId.from_dict(_item) for _item in obj["extras"]] if obj.get("extras") is not None else None
        })
        return _obj
